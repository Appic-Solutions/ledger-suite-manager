...
export const canisterId = process.env.CANISTER_ID_INDEX;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./index.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the index canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./index.did.js")._SERVICE>}
 */
export const index = createActor(canisterId);
