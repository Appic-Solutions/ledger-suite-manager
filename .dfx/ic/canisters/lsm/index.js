...
import { idlFactory } from './lsm.did.js';
export { idlFactory } from './lsm.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LSM;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lsm.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lsm canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lsm.did.js")._SERVICE>}
 */
export const lsm = createActor(canisterId);
