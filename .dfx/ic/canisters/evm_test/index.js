...
import { idlFactory } from './evm_test.did.js';
export { idlFactory } from './evm_test.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EVM_TEST;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./evm_test.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the evm_test canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./evm_test.did.js")._SERVICE>}
 */
export const evm_test = createActor(canisterId);
