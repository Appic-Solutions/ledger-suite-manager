...
export type Result = { 'Ok' : RetrieveErc20Request } |
  { 'Err' : WithdrawErc20Error };
export type Result_1 = { 'Ok' : RetrieveNativeRequest } |
  { 'Err' : WithdrawalError };
...
export type RetrieveNativeStatus = { 'NotFound' : null } |
...
export interface _SERVICE {
  ...
  >,
  'get_block_number' : ActorMethod<[], [] | [bigint]>,
  ...
  'retrieve_native_status' : ActorMethod<[bigint], RetrieveNativeStatus>,
  'smart_contract_address' : ActorMethod<[], string>,
  'withdraw_erc20' : ActorMethod<[WithdrawErc20Arg], Result>,
  'withdraw_native_token' : ActorMethod<[WithdrawalArg], Result_1>,
