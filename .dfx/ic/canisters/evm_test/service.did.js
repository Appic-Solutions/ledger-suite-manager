export const idlFactory = ({ IDL }) => {
  ...
  const RetrieveNativeStatus = IDL.Variant({
    'NotFound' : IDL.Null,
  ...
  return IDL.Service({
    ...
    'get_block_number' : IDL.Func([], [IDL.Opt(IDL.Nat)], []),
    ...
    'retrieve_native_status' : IDL.Func(
        [IDL.Nat64],
        [RetrieveNativeStatus],
        [],
      ),
    'smart_contract_address' : IDL.Func([], [IDL.Text], ['query']),
    'withdraw_erc20' : IDL.Func([WithdrawErc20Arg], [Result], []),
    'withdraw_native_token' : IDL.Func([WithdrawalArg], [Result_1], []),
